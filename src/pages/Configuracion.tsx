...
export default function Configuracion() {
  ...
  async function generarInvitacion() {
    ...
    const { data, error } = await supabase
      .from('invitaciones')
      .insert({ familia_id: currentUser.familia_id })
      .select('token')
      .single();
    ...
    setInviteLink(`${baseUrl}/unirse?token=${data.token}`);
    setInviteLoading(false);
  }
    ...
    <div className="configuracion">
      ...
      {currentUser?.familia_id && (
        <div className="config-section">
          ...
          <p className="section-description">
            Generá un link de invitación para que tu pareja se una a la familia.
          ...
          <div className="invite-card">
            {!inviteLink ? (
              ...
              >
                {inviteLoading ? 'Generando...' : 'Generar link de invitación'}
              </button>
            ) : (
              <div className="invite-link-group">
                ...
                />
                <button className="invite-copy-btn" onClick={copiarLink}>
                  Copiar
                </button>
              </div>
            )}
